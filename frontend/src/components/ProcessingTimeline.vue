...
const stageLabels: Record<string, string> = {
  ...
  translation_agent_blueprint_ready: 'Agent 蓝图', translation_agent_plan_ready: 'Agent 计划',
  translation_agent_segment_started: 'Agent 逐段', translation_agent_model_call: 'Agent 调用', translation_agent_segment_completed: 'Agent 完成',
