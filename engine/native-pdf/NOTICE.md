...
This directory and the Python runtime bundled with the DocFlow desktop apps
include an adapter for the following upstream component. The engine's installed
Python source remains unmodified in the bundled runtime; the adapter is a
separate DocFlow component.
...
- The installed distribution's license and notices remain in the bundled
  runtime alongside the package. The root project's third-party notices
