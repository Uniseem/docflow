export const ERROR_CODES = {
  ...
  scanned_with_text: 'scanned_with_text',
  pages_out_of_range: 'pages_out_of_range',
  no_paragraphs: 'no_paragraphs',
  font_embed_failed: 'font_embed_failed',
  layout_model_missing: 'layout_model_missing',
...
const PERMANENT = new Set<string>([
  ...
  ERROR_CODES.scanned_with_text,
  ERROR_CODES.pages_out_of_range,
  ERROR_CODES.no_paragraphs,
  ERROR_CODES.font_embed_failed,
  ERROR_CODES.layout_model_missing,
...
export const ERROR_MESSAGES: Record<string, string> = {
  ...
  scanned_pdf: '这个 PDF 没有文字层（可能是没做过 OCR 的扫描件），DocFlow 不做 OCR。',
  scanned_with_text:
    '这个 PDF 是扫描件，文字层多半是 OCR 的结果。可以在设置的“高级”里打开“自动处理带文字层的扫描件”后重新处理。',
  pages_out_of_range: '页码范围里没有这个 PDF 的页，请删除后重新添加并填写正确的页码。',
  no_paragraphs: '没有识别到可翻译的段落。',
  font_embed_failed: '内置中文字体无法使用，请重新安装 DocFlow。',
  layout_model_missing: '版面分析模型缺失，请重新安装 DocFlow。',
  detect_timeout: '处理超时，稍后自动重试。',
  inspect_timeout: '处理超时，稍后自动重试。',
  analyze_timeout: '处理超时，稍后自动重试。',
  scan_timeout: '处理超时，稍后自动重试。',
